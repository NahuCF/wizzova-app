...
export type PaymentStatus =
  ...
  | 'mercadopago_pending'
  | 'mercadopago_in_process'
  | 'mercadopago_in_mediation'
  | 'mercadopago_rejected'
  | 'mercadopago_cancelled'
  | 'mercadopago_authorized'
  | 'mercadopago_refunded'
  | 'mercadopago_partially_refunded'
  | 'mercadopago_charged_back'
  | 'stripe_succeeded'
  | 'stripe_pending'
  | 'stripe_failed'
  | 'stripe_cancelled'
