import type { LoginResponse, TemplateButton, TemplateCallBtn, TemplateUrlBtn, TenantsResponse } from "./index"

export const isLoginResponse = (response: LoginResponse | TenantsResponse): response is LoginResponse => {
