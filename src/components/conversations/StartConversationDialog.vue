...
const { dataPage, loading, searchTerm, rowsPerPage, fetchDataPage, loadNextPage, debouncedFetch } =
  ...
  >
    <div v-if="!showNewContact" class="flex flex-col gap-6 pt-6">
      <div class="flex justify-between items-center gap-3">
        ...
        <Select
          ...
          option-id="id"
          :option-label="
            (item: WABANumber) => `${item.verified_name} (${item.display_phone_number})`
          "
      ...
      <div ref="scrollContainer" class="flex flex-col gap-3 max-h-[300px] overflow-y-auto">
        <div
    ...
    <div v-else class="flex flex-col gap-12 pt-6">
      ...
      <div class="flex flex-col gap-2 relative">
        ...
        <InputText v-model="newContact.name" fluid class="shadow-none!" name="name" />
