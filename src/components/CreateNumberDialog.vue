...
const verifyCode = async () => {
  ...
  try {
    loading.value = true
    const { data: response } = await API.tenant.verifyNumberCode(
      newWabaNumber.value.id,
        ...
        <div v-if="step === 1" class="flex flex-col items-center gap-32 w-full">
          <div class="flex flex-col items-center gap-8 max-w-[440px]">
            <div class="flex items-center gap-6">
              <div
                class="flex justify-center items-center min-w-[35px] h-[35px] bg-emerald-200 rounded-sm"
              >
            ...
            <div class="flex items-center gap-6">
              <div
                class="flex justify-center items-center min-w-[35px] h-[35px] bg-red-200 rounded-sm"
              >
          ...
          <div class="flex justify-end w-full">
            <div class="flex gap-2">
              ...
              <Button class="font-medium" :disabled="!canConnect" @click="step = 2">
        ...
        <div v-if="step === 2" class="flex flex-col items-center gap-32 w-full">
          <div class="flex flex-col items-center gap-12 max-w-[400px] w-full px-12">
            <div class="flex flex-col gap-2 relative w-full">
              <label class="text-lg flex items-center gap-1" for="phone">
                <span class="text-neutral-800">{{
                  $t(`create_number.whatsapp_business_display_name`)
                }}</span>
              ...
              <Message v-if="errors?.businessName?._errors" severity="error" variant="simple">
            ...
            <div class="flex flex-col gap-2 relative w-full">
              ...
              <Message v-if="errors?.phone?._errors" severity="error" variant="simple">
          ...
          <div class="flex justify-end w-full">
            <div class="flex gap-2">
              ...
              <Button class="font-medium" :disabled="loading" @click="validateForm">
                <IconLoader2 v-if="loading" class="animate-spin w-6 h-6" />
                <span v-else class="flex items-center gap-1">
        ...
        <div v-if="step === 3" class="flex flex-col items-center gap-32 w-full">
          <div class="flex flex-col items-center gap-10 max-w-[400px]">
            ...
            <div class="flex flex-col items-center gap-4 relative">
              ...
              <InputOtp v-model="verificationCode" :length="6" class="w-full flex justify-center" />
          ...
          <div class="flex justify-end w-full">
            <div class="flex gap-2">
              <Button class="font-medium" :disabled="loading" @click="verifyCode">
                <IconLoader2 v-if="loading" class="animate-spin w-6 h-6" />
                <span v-else class="flex items-center gap-1">
