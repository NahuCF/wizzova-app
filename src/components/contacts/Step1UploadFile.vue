...
<template>
  <div>
    ...
    >
      <template #content>
        <div
          class="h-[416px] flex flex-col justify-center items-center border-1 border-emerald-500 rounded-lg text-center cursor-pointer bg-slate-50 hover:bg-slate-100 transition"
          ...
          <div class="flex items-center gap-2">
            ...
            <label for="addOnly" class="flex flex-col gap-1 font-normal! cursor-pointer">
              <div class="text-slate-700">
                {{ $t('contacts.import_dialog.add_only') }}
              </div>
