...
<template>
	<div class="flex flex-col gap-4">
		<div class="flex items-center">
			...
			<Select v-model="conf[actionKey]" :options="actions"
		...
		<div v-else-if="conf[actionKey] === 'assign_user'" class="flex flex-col gap-8">
			<div class="flex items-center">
				...
				<Select :modelValue="conf[assignUserKey]" @change="conf[assignUserKey] = $event.value"
					:options="userStore.users" optionValue="id" optionLabel="name" :loading="userStore.loading"
