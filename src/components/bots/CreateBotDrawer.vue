      ...
      <div class="flex flex-col items-start gap-3 relative">
        ...
        <div class="flex gap-2 w-full">
          <div class="flex items-center gap-2">
            <RadioButton v-model="bot.trigger_type" inputId="any_message" value="any_message" />
            <label for="any_message" class="text-lg font-normal cursor-pointer">
              {{ $t('bots.create_form.for_any_message') }}
            </label>
          </div>
          <div class="flex items-center gap-2">
            <RadioButton v-model="bot.trigger_type" inputId="keyword" value="keyword" />
        ...
        <div
          v-for="(keyword, index) in bot.keywords"
          class="flex flex-col w-full gap-4 relative bg-slate-100 p-3 rounded-xl"
        >
          <div class="flex flex-col gap-2 relative">
            ...
            <Message v-if="keywordErrors[index]?.keyword?.length" severity="error" variant="simple">
            ...
            <div v-if="keyword.match_type !== 'regex'" class="flex gap-5 pt-3">
              <div class="flex items-center gap-2 flex-nowrap">
                <label
                  :for="`exact_match${index}`"
                  class="text-lg font-normal cursor-pointer text-nowrap"
                >
