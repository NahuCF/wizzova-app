  ...
  >
    <div class="bg-white p-6 flex flex-col gap-8 overflow-y-auto overflow-x-hidden">
      <div class="flex flex-col gap-4">
        <div>
          <div class="flex gap-1 mb-2">
            <h2 class="font-medium text-lg">
              {{ $t('bot_workflow.question_button.header_type') }}
            </h2>
          ...
          <div class="flex gap-2 w-full">
            <div
              v-for="type in ['none', 'text', 'image', 'video', 'document']"
              class="flex items-center gap-2"
            >
              <RadioButton v-model="newData.headerType" :inputId="type" :value="type" />
        ...
        <NodeFileUpload
          v-if="
            newData.headerType === 'image' ||
            newData.headerType === 'video' ||
            newData.headerType === 'document'
          "
      ...
      <div>
        <div class="flex gap-1 mb-2">
          <h2 class="font-medium text-lg">
            {{ $t('bot_workflow.question_button.footer') }}
          </h2>
